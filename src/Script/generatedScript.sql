...
--
CREATE DATABASE IF NOT EXISTS `db_atm_simulation`;
...
INSERT INTO `account` (`accountNum`, `balance`, `ownerID`, `managedBy`)
VALUES (2542654259657329, 8153919.97, 377286, 4402627),
       (5747790651801502, 6631906.79, 400413, 7609611),
       (3328650094393971, 9066615.56, 404835, 6144223),
       (9493026305172610, 3307101.59, 417021, 8627267),
       (1832799844741109, 5382679.12, 427994, 5127384),
...
INSERT INTO `atm` (`idAtm`, `bankID`)
VALUES (371074367, 4402627),
       (220043411, 7609611),
       (369685821, 6144223),
       (101290396, 8627267),
       (113745628, 5127384),
...
INSERT INTO `bank` (`idBank`, `bankName`)
VALUES (4402627, 'Banque Marocaine du Commerce Extérieur'),
...
--
-- Table structure for table `cardlesswithdrawl`
--

DROP TABLE IF EXISTS `cardlesswithdrawl`;
CREATE TABLE IF NOT EXISTS `cardlesswithdrawl`
(
...
INSERT INTO `cardlesswithdrawl` VALUES
  (1173268059, 5308, 3200, 'Letitia Blick'),
  (1184060296, 4468, 700, 'Thelma Monahan'),
  (1269659457, 7170, 3500, 'Vicenta Wintheiser'),
  (1342347839, 4796, 1700, 'Armani Doyle'),
  (1364887932, 6363, 2200, 'Rylee Rohan'),
  (1370331359, 8820, 600, 'Jazlyn Stamm'),
  (1484322858, 6485, 3100, 'Dominic Hodkiewicz'),
  (1500382903, 7685, 3600, 'Price Mayert'),
  (1570160330, 7775, 1100, 'Miles Anderson'),
  (1625517714, 2561, 2900, 'Reymundo Kling'),
  (1724629199, 1787, 4900, 'Casandra Hyatt'),
  (1803649266, 8150, 300, 'Bailee Connelly'),
  (1831933102, 8537, 1700, 'Eliseo Sauer'),
  (1866056918, 5641, 300, 'Filomena Block'),
  (1913611002, 2119, 1800, 'Kory Murphy'),
  (1939009916, 2581, 1900, 'Morgan Gaylord'),
  (1992282892, 9783, 3500, 'Rosario Shanahan'),
  (2039890690, 4219, 600, 'Alessandro Kling'),
  (2046361884, 3989, 1300, 'Gayle Jones'),
  (2079705202, 2755, 1500, 'Bernard Mueller'),
  (2094887735, 6986, 4600, 'Lawson Lynch'),
  (2147483647, 8836, 4100, 'Joanny Ondricka');
-- --------------------------------------------------------
...
INSERT INTO `customer` (`customerID`, `name`, `address`, `birthDate`)
VALUES (377286, 'Lauren Schiller', '47318 Hauck Knoll Apt. 831\nRodriguezland, KS 92092-5784', '1985-01-09'),
...
INSERT INTO `debitcard` (`cardNum`, `expirationDate`, `cvc`, `pin`, `accountNum`)
VALUES (4997544040407235, '2025-09-01', 441, 1269, 2542654259657329),
       ...
       (4668029198774210, '2025-02-01', 867, 6924, 1832799844741109),
